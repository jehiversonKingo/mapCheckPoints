...
const filePath = '../data_markers/communities.xlsx';
    ...
    for (const row of data) {
        const insertQuery = `
            WITH newUbication AS (
                ...
                VALUES (3, 1, $1, $2, 'Guatemala', $3, 'Ciudad', 'Dirección', NOW(), NOW(), 'active')
                ON CONFLICT (lng, lat)
                DO UPDATE SET
            ...
            VALUES ((SELECT idUbication FROM newUbication), $4, 'Comunidad', 0, '#fff', NOW(), NOW(), 'active')
